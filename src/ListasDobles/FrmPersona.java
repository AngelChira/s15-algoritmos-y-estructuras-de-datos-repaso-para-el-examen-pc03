...
public class FrmPersona extends javax.swing.JFrame {
    ...
    public void mostrar() {
        ...
        if (aux == null) {
            ...
            while (aux != null) {
                taResult.append("\n"+aux.getPersona().getCod()+"\t"+aux.getPersona().getApellido()+"\t"+aux.getPersona().getNombre());
                aux = aux.getSiguiente();
            }
        }
    }

    public boolean verificarCod(Persona per) {
        Nodo aux = list.inicio;
        if (aux != null) {
            while (aux != null) {
                if (aux.getPersona().getCod().equalsIgnoreCase(per.getCod())) {
                    return false;
                }
                aux = aux.getSiguiente();
            }
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        if (verificarCod(new Persona(codigo))) {
            list.agregarFinal(new Persona(txtCod.getText().strip(), txtNom.getText().strip(), txtApell.getText().strip()));
            txtCod.setText("");
            txtNom.setText("");
            txtApell.setText("");
            mostrar();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        buscarPersona(new Persona(valorBuscar));
        if (count == 0) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!verificarCod(new Persona(codigoEliminar))) {
            list.eliminarPersona(new Persona(codigoEliminar));
            mostrar();
        } else {
    ...
    private void btnInsertarInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarInicioActionPerformed
        String codigo = txtCod.getText().strip();
        if (verificarCod(new Persona(codigo))) {
            list.agregarInicio(new Persona(txtCod.getText().strip(), txtNom.getText().strip(), txtApell.getText().strip()));
            txtCod.setText("");
            txtNom.setText("");
            txtApell.setText("");
            mostrar();
    ...
    private void btnEliminarPosicionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarPosicionActionPerformed
        ...
        list.eliminarPosicion(posicion-1);
        mostrar();
    ...
    private void btnAgregarPosicionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarPosicionActionPerformed
        ...
        String codigo = txtCod.getText().strip();
        if (verificarCod(new Persona(codigo))) {
            if (list.agregarPosicion(new Persona(txtCod.getText().strip(), txtNom.getText().strip(), txtApell.getText().strip()), posicion-1)) {
                txtCod.setText("");
                txtNom.setText("");
                txtApell.setText("");
                mostrar();
