...
public class FrmCliente extends javax.swing.JFrame {
    ...
    public void mostrar() {
        Nodo aux = lis.inicio;
        if (aux == null) {
            taResult.setText("No hay clientes.");
        } else {
            taResult.setText("CODIGO\t APELLIDOS\t NOMBRES");
            while (aux != null) {
                taResult.append("\n"+aux.getCliente().getCod()+"\t"+aux.getCliente().getApellido()+"\t"+aux.getCliente().getNombre());
                aux = aux.getSiguiente();
            }
        }
    }

    public boolean verificarCod(Cliente clie) {
        Nodo aux = lis.inicio;
        if (aux != null) {
            while (aux != null) {
                if (aux.getCliente().getCod().equalsIgnoreCase(clie.getCod())) {
                    return false;
                }
                aux = aux.getSiguiente();
            }
    ...
    public void buscarCliente(Cliente clie) {
        count =0;
        Nodo aux = lis.inicio;
        if (aux != null) {
            while (aux != null) {
                if (aux.getCliente().getCod().equalsIgnoreCase(clie.getCod())) {
                    taResult.setText("CLIENTE ENCONTRADO\nCODIGO\t APELLIDOS\t NOMBRES");
                    taResult.append("\n"+aux.getCliente().getCod()+"\t"+aux.getCliente().getApellido()+"\t"+aux.getCliente().getNombre());
                    count++;
                }
                aux = aux.getSiguiente();
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        if (verificarCod(new Cliente(codigo))) {
            lis.agregarFinal(new Cliente(txtCod.getText().strip(), txtNom.getText().strip(), txtApell.getText().strip()));
            txtCod.setText("");
            txtNom.setText("");
            txtApell.setText("");
            mostrar();
            ...
            txtCod.requestFocus();
            taResult.setText("No se agrego el cliente.");
        }
    }//GEN-LAST:event_btnInsertActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String valorBuscar = JOptionPane.showInputDialog("Ingrese el codigo del cliente a buscar.");
        buscarCliente(new Cliente(valorBuscar));
        if (count == 0) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        String codigoEliminar = JOptionPane.showInputDialog("Ingrese el codigo del cliente a eliminar");
        if (!verificarCod(new Cliente(codigoEliminar))) {
            lis.eliminarCliente(new Cliente(codigoEliminar));
            mostrar();
        } else {
    ...
    private void btnInsertarInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarInicioActionPerformed
        String codigo = txtCod.getText().strip();
        if (verificarCod(new Cliente(codigo))) {
            lis.agregarInicio(new Cliente(txtCod.getText().strip(), txtNom.getText().strip(), txtApell.getText().strip()));
            txtCod.setText("");
            txtNom.setText("");
            txtApell.setText("");
            mostrar();
    ...
    private void btnEliminarPosicionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarPosicionActionPerformed
        ...
        lis.eliminarPosicion(posicion-1);
        mostrar();
    ...
    private void btnAgregarPosicionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarPosicionActionPerformed
        ...
        String codigo = txtCod.getText().strip();
        if (verificarCod(new Cliente(codigo))) {
            if (lis.agregarPosicion(new Cliente(txtCod.getText().strip(), txtNom.getText().strip(), txtApell.getText().strip()), posicion-1)) {
                txtCod.setText("");
                txtNom.setText("");
                txtApell.setText("");
                mostrar();
